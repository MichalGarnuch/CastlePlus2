...
{
    public sealed class UpdateOdczytCommandValidator : AbstractValidator<UpdateOdczytCommand>
    {
        public UpdateOdczytCommandValidator()
        {
            // Reguła z SQL: IdOdczytu bigint NOT NULL
            RuleFor(x => x.IdOdczytu)
                .NotEmpty();

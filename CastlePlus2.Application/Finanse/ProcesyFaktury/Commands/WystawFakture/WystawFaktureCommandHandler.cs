...
namespace CastlePlus2.Application.Finanse.ProcesyFaktury.Commands.WystawFakture
{
    public class WystawFaktureCommandHandler : IRequestHandler<WystawFaktureCommand, WystawFaktureResultDto>
    {
        ...
        public WystawFaktureCommandHandler(
        ...
        public async Task<WystawFaktureResultDto> Handle(WystawFaktureCommand request, CancellationToken ct)
        {
            ...
            foreach (var pozycja in request.Pozycje)
            {
                ...
                if (sumaNetto != pozycja.KwotaNetto || sumaBrutto != pozycja.KwotaBrutto)
                {
                    throw new InvalidOperationException(
                        "Suma alokacji musi być równa kwotom pozycji (netto i brutto).");
                }
